...
async def autocomplete_addresses(
    query: str = Query(
        ..., min_length=1, description="Texte de recherche pour l'autocomplétion"
    ),
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Erreur lors de la recherche d'adresses"
        )
...
async def geocode_address(address: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Erreur lors du géocodage de l'adresse"
        )
