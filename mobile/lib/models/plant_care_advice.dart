...
class PlantCareAdvice {
  ...
  factory PlantCareAdvice.fromJson(Map<String, dynamic> json) {
...
class PlantCareWithAdvice {
  ...
  final PlantCareAdvice? currentAdvice;
  final List<PlantCareAdvice> adviceHistory;
  ...
  factory PlantCareWithAdvice.fromJson(Map<String, dynamic> json) {
    return PlantCareWithAdvice(
      ...
      currentAdvice: json['current_advice'] != null 
          ? PlantCareAdvice.fromJson(json['current_advice'])
          : null,
      adviceHistory: (json['advice_history'] as List<dynamic>?)
          ?.map((advice) => PlantCareAdvice.fromJson(advice))
          .toList() ?? [],
...
class PlantCareAdviceValidation {
  final ValidationStatus validationStatus;
  final String? validationComment;
