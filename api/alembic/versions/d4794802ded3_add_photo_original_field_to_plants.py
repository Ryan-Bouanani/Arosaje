...
def downgrade() -> None:
    ...
    sa.Column('role', postgresql.ENUM('USER', 'BOTANIST', 'ADMIN', name='userrole'), autoincrement=False, nullable=True),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('care_reports_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('health_level', postgresql.ENUM('BAS', 'MOYEN', 'BON', name='healthlevel'), autoincrement=False, nullable=False),
    sa.Column('hydration_level', postgresql.ENUM('BAS', 'MOYEN', 'BON', name='healthlevel'), autoincrement=False, nullable=False),
    sa.Column('vitality_level', postgresql.ENUM('BAS', 'MOYEN', 'BON', name='healthlevel'), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['caretaker_id'], ['users.id'], name='care_reports_caretaker_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['plant_care_id'], ['plant_cares.id'], name='care_reports_plant_care_id_fkey', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['sender_id'], ['users.id'], name='messages_sender_id_fkey', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name='messages_pkey')
    )
    op.create_table('user_typing_status',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('conversation_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('is_typing', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('last_typed_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['conversation_id'], ['conversations.id'], name='user_typing_status_conversation_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='user_typing_status_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='user_typing_status_pkey')
    )
    op.create_table('plants',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('plants_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name='plants_owner_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='plants_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('plant_cares',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('plant_cares_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('PENDING', 'ACCEPTED', 'REFUSED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='carestatus'), autoincrement=False, nullable=True),
    sa.Column('care_instructions', sa.VARCHAR(), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['caretaker_id'], ['users.id'], name='plant_cares_caretaker_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['conversation_id'], ['conversations.id'], name='plant_cares_conversation_id_fkey', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name='plant_cares_owner_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['plant_id'], ['plants.id'], name='plant_cares_plant_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('ONLINE', 'OFFLINE', 'AWAY', name='userstatus'), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='user_presence_user_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('priority', postgresql.ENUM('NORMAL', 'URGENT', 'FOLLOW_UP', name='advicepriority'), autoincrement=False, nullable=True),
    sa.Column('validation_status', postgresql.ENUM('PENDING', 'VALIDATED', 'REJECTED', 'NEEDS_REVISION', name='validationstatus'), autoincrement=False, nullable=True),
    ...
    sa.Column('is_current_version', sa.BOOLEAN(), autoincrement=False, nullable=True),
    ...
    sa.Column('botanist_notified', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['botanist_id'], ['users.id'], name='advices_botanist_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['plant_care_id'], ['plant_cares.id'], name='advices_plant_care_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['previous_version_id'], ['advices.id'], name='advices_previous_version_id_fkey', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['validator_id'], ['users.id'], name='advices_validator_id_fkey', ondelete='SET NULL'),
    ...
    sa.ForeignKeyConstraint(['plant_id'], ['plants.id'], name='photos_plant_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='photos_pkey')
    )
    op.create_table('botanist_report_advices',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['botanist_id'], ['users.id'], name='botanist_report_advices_botanist_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['care_report_id'], ['care_reports.id'], name='botanist_report_advices_care_report_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='botanist_report_advices_pkey')
    )
    op.create_table('conversations',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('type', postgresql.ENUM('PLANT_CARE', 'BOTANICAL_ADVICE', name='conversationtype'), autoincrement=False, nullable=True),
