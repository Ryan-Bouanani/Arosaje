...
async def login(
    ...
    await analytics_service.track_feature_usage(
        feature="login", platform=platform, user_id=str(user.id)
    )
...
async def register(
    ...
    await analytics_service.track_feature_usage(
        feature="register", platform=platform, user_id=str(user.id)
    )
...
async def read_users_me(request: Request, current_user=Depends(get_current_user)):
    ...
    await analytics_service.track_feature_usage(
        feature="view_profile", platform=platform, user_id=str(current_user.id)
    )
    return current_user
...
async def update_user_role(
    ...
    await analytics_service.track_feature_usage(
        feature="update_role", platform=platform, user_id=str(current_user.id)
    )
