...
class Advice(Base):
    ...
    previous_version_id = Column(Integer, ForeignKey("advices.id", ondelete="SET NULL"), nullable=True)
    ...
    previous_version = relationship("Advice", remote_side=[id], back_populates="updated_versions")
