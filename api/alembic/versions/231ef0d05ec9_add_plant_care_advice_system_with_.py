...
def upgrade() -> None:
    ...
    sa.Column('priority', sa.Enum('NORMAL', 'URGENT', 'FOLLOW_UP', name='advicepriority'), nullable=True),
    sa.Column('validation_status', sa.Enum('PENDING', 'VALIDATED', 'REJECTED', 'NEEDS_REVISION', name='validationstatus'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['plant_care_id'], ['plant_cares.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['previous_version_id'], ['plant_care_advice.id'], ondelete='SET NULL'),
