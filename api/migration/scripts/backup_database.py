...
def create_backup():
    ...
    try:
        print("🚀 Création du backup de la base de données...")
        ...
        print(
            f"📊 Taille du fichier: {backup_file.stat().st_size / 1024 / 1024:.2f} MB"
        )
...
def verify_tables():
    ...
    try:
        ...
        print(
            f"📋 Table 'plant_care_advices': {plant_care_advice_count} enregistrements"
        )
...
if __name__ == "__main__":
    ...
    print("⚠️  Conserver ce fichier précieusement avant de continuer la migration!")
